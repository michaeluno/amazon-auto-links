...
//        $this->assertFileExists( $GLOBALS['_sProjectDirPath'] . '/library/apf/admin-page-framework-include-class-list.php' );
    ...
    public function testClassExists() {
        ...
        // Output info
//        codecept_debug( 'library name: ' . LateCachingForFeeds_Registry::NAME );
//        codecept_debug( 'library dir path: ' . LateCachingForFeeds_Registry::$sDirPath );
               
//        $_iCount = 0;
//        foreach( LateCachingForFeeds_Registry::$aClassFiles as $_sClassName => $_sClassPath ) {
//            $_iCount++;
