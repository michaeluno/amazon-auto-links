...
/**
	...
	Copyright (c) 2013-2015, Michael Uno; Licensed under MIT <http://opensource.org/licenses/MIT> Included Components: Admin Pages, Custom Post Types, Post Meta Boxes, Page Meta Boxes, Widgets, Utilities
 Generated on 2016-01-04 */
if (!class_exists('AmazonAutoLinks_AdminPageFramework_Registry')):
    ...
    final class AmazonAutoLinks_AdminPageFramework_Registry extends AmazonAutoLinks_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['AmazonAutoLinks_AdminPageFramework_InclusionClassFilesHeader']) && file_exists(self::$aClassFiles['AmazonAutoLinks_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('AmazonAutoLinks_AdminPageFramework_Bootstrap')):
