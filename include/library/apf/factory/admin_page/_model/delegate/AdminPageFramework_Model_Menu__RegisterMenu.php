...
class AmazonAutoLinks_AdminPageFramework_Model_Menu__RegisterMenu extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToRegisterMenu() {
        ...
        foreach ($this->oFactory->oProp->aPages as & $aSubMenuItem) {
            $_oFormatter = new AmazonAutoLinks_AdminPageFramework_Format_SubMenuItem($aSubMenuItem, $this->oFactory, $_iParsedIndex);
    ...
    private function _setSubMenuPageByIndex($nOrder, $aSubMenuItem, $sMenuSlug) {
        AmazonAutoLinks_AdminPageFramework_Debug::log(func_get_args());
        $_nNewIndex = $this->getUnusedNumericIndex($this->getElementAsArray($GLOBALS, array('submenu', $sMenuSlug)), $nOrder, 5);
        AmazonAutoLinks_AdminPageFramework_Debug::log('new index: ' . $_nNewIndex);
