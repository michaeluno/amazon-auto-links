...
class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Import extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new AmazonAutoLinks_AdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES['__import'], false), $this->getHTTPRequestSanitized($_POST['__import'], true));
    ...
    class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Export extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Import {
        ...
        protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
            $_oExport = new AmazonAutoLinks_AdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array('__export')), true), $this->oFactory->oProp->sClassName);
