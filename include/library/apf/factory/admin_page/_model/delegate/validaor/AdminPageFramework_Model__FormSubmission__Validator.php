...
class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Link', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Import', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Export', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
