...
abstract class AmazonAutoLinks_AdminPageFramework_Router extends AmazonAutoLinks_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'amazon-auto-links') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new AmazonAutoLinks_AdminPageFramework_Property_admin_page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
    ...
    protected function _getLinkObject() {
        return new AmazonAutoLinks_AdminPageFramework_Link_admin_page($this->oProp, $this->oMsg);
    }
    protected function _getPageLoadObject() {
        return new AmazonAutoLinks_AdminPageFramework_PageLoadInfo_admin_page($this->oProp, $this->oMsg);
    }
