...
class AmazonAutoLinks_AdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function form($aFormData) {
        ...
        $this->oCaller->oForm = new AmazonAutoLinks_AdminPageFramework_Form_widget(array('register_if_action_already_done' => false,) + $this->oCaller->oProp->aFormArguments, $this->_getFormCallbacks() + $this->oCaller->oProp->aFormCallbacks, $this->oCaller->oMsg);
    }
