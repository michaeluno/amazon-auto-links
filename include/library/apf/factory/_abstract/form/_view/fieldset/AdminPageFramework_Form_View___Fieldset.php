...
class AmazonAutoLinks_AdminPageFramework_Form_View___Fieldset extends AmazonAutoLinks_AdminPageFramework_Form_View___Fieldset_Base {
    public function get() {
        $_aOutputs = array();
        $_oFieldError = new AmazonAutoLinks_AdminPageFramework_Form_View___Fieldset___FieldError($this->aErrors, $this->aField['_section_path_array'], $this->aField['_field_path_array'], $this->aField['error_message']);
        $_aOutputs[] = $_oFieldError->get();
        $_oFieldsFormatter = new AmazonAutoLinks_AdminPageFramework_Form_Model___Format_Fields($this->aField, $this->aOptions);
