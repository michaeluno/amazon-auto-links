<?php
class AmazonAutoLinks_AdminPageFramework_Form_View__Resource extends AmazonAutoLinks_AdminPageFramework_WPUtility {
    public $oForm;
    ...
    public function _replyToAddStyle() {
        ...
        if ($_sCSSRules) {
            echo "<style type='text/css' id='inline-style-{$_sID}' class='amazon-auto-links-form-style'>" . $_sCSSRules . "</style>";
        }
        $_sIECSSRules = $this->_getFormattedInlineStyles($this->oForm->getResources('inline_styles_ie'));
        if ($_sIECSSRules) {
            echo "<!--[if IE]><style type='text/css' id='inline-style-ie-{$_sID}' class='amazon-auto-links-form-ie-style'>" . $_sIECSSRules . "</style><![endif]-->";
        }
    ...
    public function _replyToAddScript() {
        ...
        if ($_sScript) {
            $_sID = $this->sanitizeSlug(strtolower($this->oForm->aArguments['caller_id']));
            echo "<script type='text/javascript' id='inline-script-{$_sID}' class='amazon-auto-links-form-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
        }
