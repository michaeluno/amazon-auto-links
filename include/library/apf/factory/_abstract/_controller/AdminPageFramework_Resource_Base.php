<?php
abstract class AmazonAutoLinks_AdminPageFramework_Resource_Base extends AmazonAutoLinks_AdminPageFramework_WPUtility {
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->_getCallerObject(), array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), AmazonAutoLinks_AdminPageFramework_Property_Base::$_sDefaultScript);
