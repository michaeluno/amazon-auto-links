...
abstract class AmazonAutoLinks_AdminPageFramework_PostType_Router extends AmazonAutoLinks_AdminPageFramework_Factory {
    ...
    protected function _getLinkObject() {
        return new AmazonAutoLinks_AdminPageFramework_Link_post_type($this->oProp, $this->oMsg);
    }
    protected function _getPageLoadObject() {
        return new AmazonAutoLinks_AdminPageFramework_PageLoadInfo_post_type($this->oProp, $this->oMsg);
    }
...
abstract class AmazonAutoLinks_AdminPageFramework_PostType extends AmazonAutoLinks_AdminPageFramework_PostType_Controller {
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'amazon-auto-links') {
        ...
        $this->oProp = new AmazonAutoLinks_AdminPageFramework_Property_post_type($this, $this->_getCallerScriptPath($sCallerPath), get_class($this), 'publish_posts', $sTextDomain, 'post_type');
