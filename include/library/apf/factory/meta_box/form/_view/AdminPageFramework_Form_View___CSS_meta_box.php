...
.postbox .amazon-auto-links-section .form-table > tbody > tr > td,
.postbox .amazon-auto-links-section .form-table > tbody > tr > th
{
...
#poststuff .metabox-holder .postbox-container .amazon-auto-links-section-title h3 {
    border: none;
    font-weight: bold;
    font-size: 1.12em;
    margin: 1em 0;
...
#poststuff .metabox-holder .postbox-container .amazon-auto-links-collapsible-title h3 {
    margin: 0;
}
...
#poststuff .metabox-holder .postbox-container .amazon-auto-links-section-tab h4 {
    margin: 0;
}
...
@media screen and (min-width: 783px) {    
    ...
    #poststuff #post-body.columns-2 #side-sortables .postbox .amazon-auto-links-section .form-table input[type=text]{
        width: 98%;
    }
}            
CSSRULES;
