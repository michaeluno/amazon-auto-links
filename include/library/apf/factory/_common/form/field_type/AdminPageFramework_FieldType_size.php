...
class AmazonAutoLinks_AdminPageFramework_FieldType_size extends AmazonAutoLinks_AdminPageFramework_FieldType_select {
    ...
    protected function getStyles() {
        return ".amazon-auto-links-field-size input {text-align: right;}.amazon-auto-links-field-size select.size-field-select {vertical-align: 0px; }.amazon-auto-links-field-size label {width: auto; } .form-table td fieldset .amazon-auto-links-field-size label {display: inline;}";
    }
    protected function getField($aField) {
