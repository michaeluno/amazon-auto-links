...
jQuery( document ).ready( function() {
    jQuery( '.amazon-auto-links-field-import input[type=submit]' ).on( 'click', function( event ) {
        var _iFiles = jQuery( this ).closest( '.amazon-auto-links-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".amazon-auto-links-field-import input {margin-right: 0.5em;}.amazon-auto-links-field-import,.amazon-auto-links-field-import .amazon-auto-links-input-label-container {width: 100%;}.amazon-auto-links-field-import label,.form-table td fieldset.amazon-auto-links-fieldset .amazon-auto-links-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
