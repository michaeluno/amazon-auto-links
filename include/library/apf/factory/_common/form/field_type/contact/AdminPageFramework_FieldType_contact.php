...
class AmazonAutoLinks_AdminPageFramework_FieldType_contact extends AmazonAutoLinks_AdminPageFramework_FieldType_submit {
    ...
    protected function getEnqueuingScripts() {
        return array(array('handle_id' => 'amazon-auto-links-contact-field-type', 'src' => dirname(__FILE__) . '/js/contact.bundle.js', 'in_footer' => true, 'dependencies' => array('jquery',), 'translation_var' => 'AmazonAutoLinks_AdminPageFrameworkContactFieldType', 'translation' => array('nonce' => wp_create_nonce(get_class($this)), 'action' => $this->___sAction, 'messages' => array('requiredField' => $this->oMsg->get('please_fill_out_this_field'),),),),);
    }
