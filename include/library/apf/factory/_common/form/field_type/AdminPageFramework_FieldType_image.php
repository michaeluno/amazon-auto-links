...
.amazon-auto-links-field .image_preview {
    border: none; 
    clear: both; 
    margin-top: 0.4em;
    margin-bottom: 0.8em;
...
.amazon-auto-links-field .image_preview img {     
    display: block;  
    height: auto; 
    max-width: 100%;
}
.widget .amazon-auto-links-field .image_preview {
    max-width: 100%;
}            
...
.amazon-auto-links-field-image input {
    margin-right: 0.5em;
...
jQuery( document ).ready( function(){     
    setAmazonAutoLinks_AdminPageFrameworkImageUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
