...
class AmazonAutoLinks_AdminPageFramework_Format_SubMenuPage extends AmazonAutoLinks_AdminPageFramework_Format_Base {
     ...
     * 
     * @since       2.0.0
     * @since       3.1.1       Moved from `AmazonAutoLinks_AdminPageFramework_Menu`.
     * @since       3.6.0       Moved from `AmazonAutoLinks_AdminPageFramework_Menu_Model`.
     ...
     * 
     * @since       2.0.0
     * @since       3.3.1       Moved from `AmazonAutoLinks_AdminPageFramework_Page`.
     * @since       3.6.0       Moved from `AmazonAutoLinks_AdminPageFramework_Page_Model`.
     * @var         array
     * @static
     * @access      public
     * @internal
