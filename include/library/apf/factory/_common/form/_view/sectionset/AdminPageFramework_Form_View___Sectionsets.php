...
class AmazonAutoLinks_AdminPageFramework_Form_View___Sectionsets extends AmazonAutoLinks_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return $this->___getSpinnerOutput($_sOutput) . "<div id='{$_sElementID}' class='amazon-auto-links-sctionsets amazon-auto-links-form-js-on'>" . $_sOutput . $_oDebugInfo->get() . "</div>";
    }
