...
class AmazonAutoLinks_AdminPageFramework_Form_View___ToolTip extends AmazonAutoLinks_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return "<a " . $this->_getElementAttributes('container', array('amazon-auto-links-form-tooltip', 'no-js')) . ">" . $this->_getTipLinkIcon() . "<span " . $this->_getElementAttributes('content', 'amazon-auto-links-form-tooltip-content') . ">" . $this->_getTipTitle() . $this->_getDescriptions() . "</span>" . "</a>";
    }
