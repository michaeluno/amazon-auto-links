...
class AmazonAutoLinks_AdminPageFramework_Form_View___Attribute_Fieldset extends AmazonAutoLinks_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sContext . '-' . $this->aArguments['tag_id'], 'class' => implode(' ', array('amazon-auto-links-' . $this->sContext, $this->_getSelectorForChildFieldset())), 'data-field_id' => $this->aArguments['tag_id'],);
    }
