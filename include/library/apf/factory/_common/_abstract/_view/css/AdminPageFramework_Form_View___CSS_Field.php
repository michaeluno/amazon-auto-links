...
class AmazonAutoLinks_AdminPageFramework_Form_View___CSS_Field extends AmazonAutoLinks_AdminPageFramework_Form_View___CSS_Base {
    ...
    protected function _getVersionSpecific() {
        ...
        if (version_compare($GLOBALS['wp_version'], '3.8', '>=')) {
            $_sCSSRules.= ".amazon-auto-links-repeatable-field-buttons {margin: 2px 0 0 0.3em;} @media screen and ( max-width: 782px ) {.amazon-auto-links-fieldset {overflow-x: hidden;}}";
        }
        return $_sCSSRules;
    }
}
