...
class AmazonAutoLinks_AdminPageFramework_Message {
    ...
    private function ___doDummy()
    {
        ...
        __('Submit the form.', 'amazon-auto-links');
        __('Please check this box if you want to proceed.', 'amazon-auto-links');
        __('No file is selected.', 'amazon-auto-links');
        __('Please fill out this field.', 'amazon-auto-links');
    }
}
