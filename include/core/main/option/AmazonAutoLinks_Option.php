...
class AmazonAutoLinks_Option extends AmazonAutoLinks_Option_Base {
    ...
    public function getDefaultOutputFormats() {
        ...
        return array(
            ...
            'image_format' => '<div class="amazon-product-thumbnail" style="max-width:%image_size%px; ">' . PHP_EOL // 4.3.0 Removed max-height:%image_size%px; as the sub-image container overlaps the thumbnail
