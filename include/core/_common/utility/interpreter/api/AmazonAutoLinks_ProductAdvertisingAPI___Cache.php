...
class AmazonAutoLinks_ProductAdvertisingAPI___Cache extends AmazonAutoLinks_PluginUtility {
     ...
     */
    public function get() {
        return $this->___setAPIRequestCache(
            $this->___sRequestURI,
     ...
     */
    private function ___setAPIRequestCache( $sRequestURI, array $aHTTPArguments, $iDuration, $bForceCaching ) {
    
        // Perform the API request. 
        $_asXMLResponse = $this->___requestSigned( $sRequestURI, $aHTTPArguments, $iDuration, $bForceCaching );
         ...
         */
        private function ___requestSigned( $sRequestURI, array $aHTTPArguments=array(), $iDuration, $bForceCaching=false ) {
