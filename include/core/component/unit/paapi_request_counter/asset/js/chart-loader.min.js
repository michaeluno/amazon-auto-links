...
function getChartCreated(oChartElement,aX,aY,iTotal){var _oChartContainer=oChartElement.parent();_oChartContainer.after("<input type='hidden' name='chart-x' value='"+aX.join('|')+"'/>");_oChartContainer.after("<input type='hidden' name='chart-y' value='"+aY.join('|')+"'/>");return new Chart(oChartElement,{"type":"line","data":{"labels":aX,"datasets":[{"label":aalChartJSLoader.labels.counts+' ('+aalChartJSLoader.labels.total+': '+iTotal+')',"data":aY,"fill":!1,"borderColor":"rgb(75, 192, 192)","lineTension":0}]},"options":{responsive:!0,maintainAspectRatio:!0,legend:{display:!0,},tooltips:{callbacks:{title:function(tooltipItems,data){return data.labels[tooltipItems[0].index]},label:function(tooltipItem,data){return aalChartJSLoader.labels.count+': '+tooltipItem.yLabel}}},scales:{xAxes:[{type:'time',time:{unit:'day',displayFormats:{day:'YYYY-MMM-D',},tooltipFormat:'ll',parser:function(utcMoment){return moment(utcMoment).utcOffset(aalChartJSLoader.GMTOffset)}},ticks:{callback:_formatDateLabel,source:'labels'},scaleLabel:{display:!0,labelString:aalChartJSLoader.labels.dates}}],yAxes:[{scaleLabel:{display:!0,labelString:aalChartJSLoader.labels.counts},ticks:{suggestedMin:0,stepSize:1}}]}}})}
...
return sValue}
function debugLog(...args){if(!parseInt(aalChartJSLoader.debugMode)){return}
console.log(aalChartJSLoader.pluginName+' (Chart Loader):',...args)}}(jQuery))