/* Chart Loader 1.0.2 */
(function($){var _oCanvasContainer;var _oChartElement;var _oChart;$(document).ready(function(){if('undefined'===typeof aalChartJSLoader){debugLog('Amazon Auto Links','Chart Loader','The script dat is not passed.');return;}
if(aalChartJSLoader.debugMode){debugLog('Amazon Auto Links','Chart Loader',aalChartJSLoader);}
...
console.log('AAL Debug (Chart Loader):',...args);}}(jQuery));;