...
class AmazonAutoLinks_SVGGenerator_RatingStar extends AmazonAutoLinks_SVGGenerator_Base {
    ...
    protected function _getDefinition( $bVisible=false ) {
        ...
        return "<svg {$_sClass} data-class='definition' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width=0 height=0 viewBox='0 0 160 32' {$_sDisplay}>"
