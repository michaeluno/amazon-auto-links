...
//        return $_bHasPrime;
    ...
    static public function getRatingOutput( $iRating, $sReviewURL='', $iReviewCount=null ) {
        ...
        static private function ___getRatingStarsSVG( $sTitle, $iRating, $sFallbackIMGSRC ) {
            ...
            $_sSVGDefinition        = '';
            $_sDefsGradient          = '';
            $_sCSSInvisible         = 'position:fixed;height:0;width:0;bottom:0;left:0;z-index:-999;display:inline;opacity:0;';

            if ( ! isset( $_aDefinitions[ 'main' ] ) ) {
                $_sSVGDefinition = "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width=0 height=0 viewBox='0 0 160 32' style='{$_sCSSInvisible}'>"
