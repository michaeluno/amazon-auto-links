...
function convertAmazonLinksByGeolocation(aAPIProviders){var localCache=getLocalStorageTTL(localStorageKey,86400*7);debugLog('Stored cache:',localCache);if(localCache&&'undefined'!==typeof localCache.locale){convertLinks(localCache.locale);return;}
...
function debugLog(...args){if(!aalGeoResolver.debugMode){return;}
console.log('AAL Debug(Geotargeting):',...args);}
function getJSONObjectCloned(jsonObj){return JSON.parse(JSON.stringify(jsonObj));}}(jQuery));;