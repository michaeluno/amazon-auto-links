/**
 * @name    Button2 Button Preview Event Binder
 * @version 1.0.0
 */
(function ( $ ) {

  /* global aalButton2ButtonPreviewEventBinder, */
  $( document ).ready( function () {

    console.log( 'AAL Button Preview - Button2', aalButton2ButtonPreviewEventBinder );
    if ( 'undefined' === typeof aalButton2ButtonPreviewEventBinder ) {
      return;
    }

    var buttonID                        = 'undefined' === typeof aalButton2ButtonPreviewEventBinder.postID
      ? '___button_id___'
      : aalButton2ButtonPreviewEventBinder.postID;
    ...
    var previewFrame                = $( '#button-preview-button2 > iframe' ).first();
    ...
    inputs.on( 'change input', function () {
      ...
      debouncers[ '_stylesheet_generator' ] = setTimeout( function () {
        ...
        _setStyleSheetInFramedPage( _style, 'button-preview-button2-framed-stylesheet', previewFrame );
        ...
        previewFrame[ 0 ].contentWindow.postMessage(
          {
            ...
            nonce:   aalButton2ButtonPreviewEventBinder.nonce,
          },
