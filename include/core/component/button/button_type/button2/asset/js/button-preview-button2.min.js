...
function getBoolean(string){switch(string.toLowerCase().trim()){case "true":case "yes":case "1":return!0;case "false":case "no":case "0":case null:return!1;default:return Boolean(string)}}
function getURLExtension(url){return url.split(/[#?]/)[0].split('.').pop().trim()}})}(jQuery))