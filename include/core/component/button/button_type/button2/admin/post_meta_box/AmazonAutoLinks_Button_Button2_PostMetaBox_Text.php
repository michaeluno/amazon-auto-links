 ...
 * @since 5.2.0
 */
class AmazonAutoLinks_Button_Button2_PostMetaBox_Text extends AmazonAutoLinks_Button_Button2_PostMetaBox_Base {
    ...
    protected $_aFieldClasses = array(
        'AmazonAutoLinks_Button_Button2_FormFields_Text',
    );
