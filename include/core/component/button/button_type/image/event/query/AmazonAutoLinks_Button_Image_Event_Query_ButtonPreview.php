...
class AmazonAutoLinks_Button_Image_Event_Query_ButtonPreview extends AmazonAutoLinks_Button_Event_Query_ButtonPreview_Base {
    ...
    protected function _getHeadTagInnerHTML() {
        ...
        $_sHeadTagInnerHTML .= "<script id='button-preview-framed-image-js' src='" . esc_url( $_sScriptURL ) . "' type='text/javascript'></script>";
        $_sHeadTagInnerHTML .= "<link rel='stylesheet' id='button-preview-framed-style' href='" . esc_url( $_sStylesheetURL1 ) . "' media='all'>";
        $_sHeadTagInnerHTML .= "<link rel='stylesheet' id='button-image-preview-framed-style' href='" . esc_url( $_sStylesheetURL2 ) . "' media='all'>";
