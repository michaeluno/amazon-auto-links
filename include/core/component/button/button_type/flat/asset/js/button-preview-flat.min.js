...
styleHolder[_styleKeyIcon].display='inline-flex';var _url=$(self).val().trim();if(!_url.length){delete styleHolder[_styleKeyIcon]['background-color'];delete styleHolder[_styleKeyIcon]['-webkit-mask-image'];delete styleHolder[_styleKeyIcon]['mask-image'];delete styleHolder[_styleKeyIcon]['-webkit-mask-position'];delete styleHolder[_styleKeyIcon]['mask-position'];delete styleHolder[_styleKeyIcon]['-webkit-mask-repeat'];delete styleHolder[_styleKeyIcon]['mask-repeat'];return}
var _urlCSS="url('"+_url+"')";if(this.isSVGMaskEnabled(_pos)){delete styleHolder[_styleKeyIcon]['background-image'];styleHolder[_styleKeyIcon]['background-color']=$('.dynamic-button-field input[type=text][data-property=_icon_svg_mask_'+_pos+']').val()}else{delete styleHolder[_styleKeyIcon]['background-color'];styleHolder[_styleKeyIcon]['background-image']=_urlCSS}
...
delete styleHolder[_styleKeyIcon]['background-color'];$("input[type=text][data-property='_icon_svg_file_"+_pos+"']").trigger('change')};_processor['_icon_svg_mask_'+_pos]=function(self){if(!this.isIconEnabled(_pos)){styleHolder[_styleKeyIcon]={};return}
if(this.getIconType(_pos)!=='svg_file'){delete styleHolder[_styleKeyIcon]['background-color'];return}
styleHolder[_styleKeyIcon]['background-color']=$(self).val()};return _processor}}}
