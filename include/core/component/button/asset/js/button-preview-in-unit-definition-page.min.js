/* Button Preview in Unit Definition Page 1.0.1 */
...
_oButtonContainer.hide();___setButtonLabel_iframe(_sButtonLabel,oSelect);_oButtonContainer.siblings('.iframe-button-preview-container').css({'position':'static','top':0,'z-depth':1,});};var _oButtonSelect=$('.button-select-row').find('select');_oButtonSelect.change(function(){_setPreviewButton($(this).val(),$(this));});_oButtonSelect.trigger('change');$('input.override-button-label[type=checkbox]').change(function(){if(!$(this).prop('checked')){___revertButtonLabels(_oButtonSelect);return;}
