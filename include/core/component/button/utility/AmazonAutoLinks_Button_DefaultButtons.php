    ...
    public function __construct() {
        $this->aDefaultButtons = array(
            ...
            'https://aal-default-button/flat-default'                    => array(
                ...
                'css'          => ".amazon-auto-links-button-___button_id___ { margin-right: auto; margin-left: auto; white-space: nowrap; text-align: center; display: inline-flex; justify-content: space-around; font-size: 13px; color: #ffffff; font-weight: 400; padding-top: 8px; padding-right: 16px; padding-bottom: 8px; padding-left: 16px; border-radius: 4px; border-color: #1f628d; border-width: 1px; background-color: #4997e5; transform: scale(0.98); border-style: none; background-solid: solid; } .amazon-auto-links-button-___button_id___ .button-icon { margin-right: auto; margin-left: auto; display: none; height: auto; } .amazon-auto-links-button-___button_id___ .button-icon-left { display: inline-flex; background-color: #ffffff; background-size: contain; background-position: center; background-repeat: no-repeat; -webkit-mask-image: url('http://localhost/test-amazon-auto-links/wp-content/plugins/amazon-auto-links/include/core/component/button/asset/image/icon/cart.svg'); mask-image: url('http://localhost/test-amazon-auto-links/wp-content/plugins/amazon-auto-links/include/core/component/button/asset/image/icon/cart.svg'); -webkit-mask-position: center center; mask-position: center center; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; margin: 0px; min-height: 17px; min-width: 17px; } .amazon-auto-links-button-___button_id___ .button-label { margin-top: 0px; margin-right: 8px; margin-bottom: 1px; margin-left: 8px; } .amazon-auto-links-button-___button_id___ > * { align-items: center; display: inline-flex; vertical-align: middle; } .amazon-auto-links-button-___button_id___:hover { transform: scale(1.0);; filter: alpha(opacity=70); opacity: 0.7; }",
            ),
