...
var _sBody="<div class='result-body' style='display:none'>"+_sPurpose+_sDetails+_sCurrentItem+"</div>";var _sResult="<div class='result-container' data-success='"+_iSucceed+"'>"+_sHeader+_sBody+"</div>";_oTestTag.append(_sResult);});}});$(document).on('keydown','input.test-tags',function(event){if("Enter"!==event.key){return true;}
