...
return array(
    ...
    "Test_AmazonAutoLinks_HTTPClient_Widget_API" => AmazonAutoLinks_Test_Loader::$sDirPath . "/run/tests/http/widget/api/Test_AmazonAutoLinks_HTTPClient_Widget_API.php", 
