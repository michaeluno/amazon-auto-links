...
class Test_AmazonAutoLinks_Unit_PAAPIRequestCounter_LogRetriever_Database extends AmazonAutoLinks_UnitTest_Base {
    ...
    //     $_oFileLog = new AmazonAutoLinks_Unit_PAAPIRequestCounter_LogRetriever_Database( 'US' );
    ...
    //     $_oMock     = new AmazonAutoLinks_MockClass( 'AmazonAutoLinks_Unit_PAAPIRequestCounter_LogRetriever_Database', array( 'US' ) );
